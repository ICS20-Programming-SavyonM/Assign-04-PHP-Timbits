...
<body>
    ...
    <form method="post" action="">
        ...
        <select id="timbits" name="timbits">
            <option value="" selected disabled>Please select a size</option>
...
if (isset($_POST['submit'])) {
    $pack = isset($_POST['timbits']) ? $_POST['timbits'] : '';
    ...
    if (empty($pack) && empty($toppings) && empty($secondToppings) && empty($coffee)) {
      
        // Display error message
        echo "<p>Please select what you would like to order.</p>";
    } else {
        $pack_cost = 0;
        $topping_cost = 0;
    ...
    // Display message if the form has been submitted without any selections
    echo "<p>Please select what you would like to order.</p>";
}
  //GIF on this page
